...
export function HeroSection() {
    ...
    return (
        <section className="relative flex min-h-[90vh] flex-col items-center justify-center px-4 pt-20 text-center selection:bg-emerald-500/30 overflow-hidden">
            ...
            >
                <motion.h1 variants={textVariants} className="mb-6 max-w-5xl text-5xl font-extrabold tracking-tighter text-white sm:text-7xl lg:text-8xl leading-tight">
                ...
                <motion.p variants={textVariants} className="max-w-2xl text-lg font-medium tracking-tight text-slate-400/90 sm:text-xl leading-relaxed">
