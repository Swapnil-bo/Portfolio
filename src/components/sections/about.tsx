            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <GlassCard className="flex flex-col justify-center">
                    ...
                    <p className="mb-6 text-lg text-slate-400 leading-relaxed">
                        I&apos;m an <span className="text-white font-medium tracking-tight">aspiring AI Engineer</span>, immersed in the world of Generative AI and local LLM workflows. I specialize in &quot;vibe coding&quot;—a workflow where intuition, rapid iteration, and agentic AI pairs seamlessly to craft premium digital experiences.
                    </p>
